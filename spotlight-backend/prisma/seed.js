...
async function main() {
  ...
  await prisma.teamMember.createMany({
    data: [
      {
        name: { en: 'Odai Alabsi', nl: 'Odai Alabsi' },
        role: { en: 'Founder & Team Leader', nl: 'Oprichter & Teamleider' },
        image: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786274808/Gemini_Generated_Image_1udncc1udncc1udn_4_ku6pe4.png',
        sortOrder: 1
      },
      {
        name: { en: 'Ahmad Ahmad', nl: 'Ahmad Ahmad' },
        role: { en: 'Senior Electrician', nl: 'Eerste Elektricien' },
        image: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786274838/Gemini_Generated_Image_1udncc1udncc1udn_3_l1wmk0.png',
        sortOrder: 2
      },
      {
        name: { en: 'Ahmad Ahmad', nl: 'Ahmad Ahmad' },
        role: { en: 'Project Supervisor', nl: 'Project Supervisor' },
        image: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786274868/Gemini_Generated_Image_1udncc1udncc1udn_2_tbbsou.png',
        sortOrder: 3
      },
      {
        name: { en: 'Smart Systems Specialist', nl: 'Specialist Slimme Systemen' },
        role: { en: 'Smart Systems Specialist', nl: 'Specialist Slimme Systemen' },
        image: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786274904/Gemini_Generated_Image_1udncc1udncc1udn_1_jaxbvx.png',
        sortOrder: 4
      }
    ],
  ...
  const createdServices = await Promise.all([
    prisma.service.create({
      data: {
        slug: { en: 'residential-renovation', nl: 'residential-renovation' },
        name: { en: 'Residential Renovation', nl: 'Residentiële Renovatie' },
        description: { en: 'Residential network renovation and overhaul services', nl: 'Renovatiediensten voor woningen' },
        mainImage: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786273843/a3bbd08db2317a71609e67af404107fe78695fa7_zhyut4.png',
        videoUrl: 'https://res.cloudinary.com/demo/video/upload/sample.mp4',
        beforeAfters: {
          create: [
    ...
    prisma.service.create({
      data: {
        slug: { en: 'solar-panels', nl: 'solar-panels' },
        name: { en: 'Solar Panels', nl: 'Zonnepanelen' },
        description: { en: 'Installation and maintenance of solar panel systems', nl: 'Installatie van zonnepanelen' },
        mainImage: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786273889/90924987c47ba16a161599eaed139f64ed952d4b_dm84ic.png',
        videoUrl: 'https://res.cloudinary.com/demo/video/upload/sample.mp4'
      }
    }),
    prisma.service.create({
      data: {
        slug: { en: 'charging-stations', nl: 'charging-stations' },
        name: { en: 'Charging Stations', nl: 'Laadpalen' },
        description: { en: 'Installation of electric vehicle charging stations', nl: 'Installatie van laadpalen' },
        mainImage: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786273927/2614c4d2b1b09a4f5a1646e66b80d459c1a2dbb3_xy3zyb.png',
        videoUrl: 'https://res.cloudinary.com/demo/video/upload/sample.mp4'
      }
    }),
    prisma.service.create({
      data: {
        slug: { en: 'breakdown-service', nl: 'breakdown-service' },
        name: { en: 'Emergency Breakdown Service', nl: 'Storingsdienst' },
        description: { en: '24/7 electrical breakdown maintenance and repair', nl: '24/7 storingsdienst voor elektra' },
        mainImage: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786273975/c66326be97e184c017feb1c972cb86e27b7777ce_kmbscn.png',
        videoUrl: 'https://res.cloudinary.com/demo/video/upload/sample.mp4'
      }
    }),
    prisma.service.create({
      data: {
        slug: { en: 'electricity-installation', nl: 'electricity-installation' },
        name: { en: 'Electrical Installation', nl: 'Elektrische Installaties' },
        description: { en: 'Complete electrical wiring setup and installation', nl: 'Volledige elektrische installaties' },
        mainImage: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786274012/59b88452ef8636e4990d4d946db32c9763b39c1a_jd7wfq.png',
        videoUrl: 'https://res.cloudinary.com/demo/video/upload/sample.mp4'
      }
    })
  ...
  await prisma.project.createMany({
    data: [
      {
        title: { en: 'Modern Luxury Villa Project', nl: 'Modern Luxury Villa Project' },
        slug: { en: 'modern-luxury-villa', nl: 'modern-luxury-villa' },
        description: { en: 'Lighting and wiring project for a modern luxury villa', nl: 'Verlichting en bedrading voor een luxe villa' },
        mainImage: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786274285/d23078205585c77119a79b0f8e24cc8fddaa714f_amhcla.png',
        isActive: true
      },
      {
        title: { en: 'Before & After Villa Renovation', nl: 'Before & After Villa Renovation' },
        slug: { en: 'before-after-villa-renovation', nl: 'before-after-villa-renovation' },
        description: { en: 'Complete restructuring and renovation of the electrical system', nl: 'Volledige herstructurering van het elektrische systeem' },
        mainImage: 'https://res.cloudinary.com/df7chxawb/image/upload/v1786274383/df3ee4c25068dcfe78216515e83d0971cc183c67_t79ntf.png',
        isActive: true
      }
    ],
